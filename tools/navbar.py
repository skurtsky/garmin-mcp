...
the plan viewer (the plan list is reached from Settings).
...
def render_nav_html(active: str | None = None, token: str | None = None, *,
    ...
    ``fitness``, ``gear``, ``weekly-summary``, ``settings``; the
